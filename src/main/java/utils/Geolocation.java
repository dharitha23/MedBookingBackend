 ...
 * 
 * Note: The following code was taken from the previous mentioned source. The code has not been modified because
 * it does the exact Geolocation operations needed for the project.
 */
